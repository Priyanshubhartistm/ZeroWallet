...
import { Fingerprint, LayoutDashboard, Zap, Bug, AlertTriangle, LogOut, Sun, Moon } from 'lucide-react';
...
function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="relative w-10 h-10 rounded-lg flex items-center justify-center text-muted-foreground hover:text-primary hover:bg-secondary/60 transition-all duration-300 group"
