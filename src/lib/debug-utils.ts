// Transaction debug utilities for ZeroWallet
...
export function getRoleExplanation(role: string): string {
  const explanations: Record<string, string> = {
    payer: 'This account pays for transaction fees. In ZeroWallet paymaster mode, this is the paymaster service.',
    authority: 'This account has signing authority over the operation. In ZeroWallet, this is your smart wallet.',
...
export const EDUCATIONAL_CONTENT = {
  ...
  smartWallet: {
    ...
    points: [
      ...
      'ZeroWallet automatically creates and manages this for you',
    ],
  },
  paymaster: {
  ...
  instructions: {
    ...
    points: [
      'ZeroWallet accepts instructions, not full transactions',
      'This gives ZeroWallet control over fee payment and signing',
      'You build what you want to do, ZeroWallet handles the rest',
