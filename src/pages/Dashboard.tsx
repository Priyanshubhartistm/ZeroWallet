          ...
          <div className="mb-8">
            <div className="flex items-center gap-3 mb-2">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">Your ZeroWallet smart wallet is ready</p>
              </div>
            </div>
          </div>
              ...
              <div className="glass rounded-2xl p-6 border-l-4 border-l-primary animate-fade-in" style={{ animationDelay: '100ms' }}>
                ...
                <ul className="space-y-3 text-sm text-muted-foreground">
                  ...
                  <li className="flex items-start gap-3">
                    ...
                    <span>ZeroWallet automatically created a smart wallet account on Solana Devnet</span>
                  </li>
                  <li className="flex items-start gap-3">
