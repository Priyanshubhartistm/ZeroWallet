...
const features = [
  ...
  },
  {
    ...
    description: 'ZeroWallet creates and manages on-chain smart wallets automatically for each user — no extensions needed.',
  },
  {
    icon: Zap,
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground max-w-lg mx-auto">
              This playground teaches you the core concepts of passkey-powered, gasless Solana development
            </p>
          </div>
          ...
          <div className="max-w-3xl mx-auto">
            <div className="glass rounded-2xl p-8">
              ...
              <div className="flex flex-col md:flex-row items-center justify-between gap-4 md:gap-8 mb-8">
                {['User', 'Passkey', 'ZeroWallet', 'Smart Wallet'].map((step, index) => (
              ...
              <div className="space-y-4 text-sm text-muted-foreground">
                ...
                <p className="flex items-start gap-2">
                  ...
                  <span><strong className="text-foreground">ZeroWallet</strong> links your passkey to an on-chain smart wallet account</span>
                </p>
                <p className="flex items-start gap-2">
